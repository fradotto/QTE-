...
by running the code reported in the file "RunModels.R" whielthe approximation of the standard errors
of the quantile regression model can be computed by running the code provided within the file "SeQuantile.R".
