...
by running the code reported in the file "RunModels.R". More specifically, in lines 67-76 the gbm model is performed and all the tuning parameters are specified included the number of cross validation folds k; while the approximation of the standard errors
